...
/*-------------------------SOLUTION-------------------------*/
// Directed Graph Eular Path and Eular Circuit
...
void solve()
{
    ...
    int startNode = -1, endNode = -1, unbalanced = 0;
    ...
    for (int i = 1; i <= n; i++)
    {
        if (indegree[i] != outdegree[i])
        {
            ...
            {
                cout << "Eulerian Path or Circuit not possible\n";
                return;
            }
        }
    }
    ...
    if (unbalanced == 0)
    {
        // Eular Circuit
        startNode = 1;
        while (startNode != n && outdegree[startNode] == 0)
        {
            startNode++;
        }
    ...
    else if (unbalanced != 2 || startNode == -1 || endNode == -1)
    {
        cout << "Eulerian Path or Circuit not possible\n";
        return;
    }
